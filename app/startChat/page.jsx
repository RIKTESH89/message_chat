                ...
                chatHistory.map(({ senderId, body, createdAt, id }, index) => (
                    <div key={id} className={`flex items-start gap-2.5 ${sender === senderId ? "justify-end" : ""}`}>
                        <div className="flex flex-col gap-1 w-full max-w-[320px]">
                            ...
                            <div className={`flex flex-col leading-1.5 p-4 border-gray-200 rounded-e-xl rounded-es-xl ${sender !== senderId ? "bg-gray-100 dark:bg-gray-700" : "bg-gray-100 dark:bg-gray-700"}`}>
